...
Chi-Square test examined aggregate totals, but it did not account for year-to-year variability. To address this, we aggregate crash counts by year and season to calculate the mean yearly crash rate. We then perform a One-Way ANOVA to determine if the average number of airplane crashes per year differs significantly across the months.
