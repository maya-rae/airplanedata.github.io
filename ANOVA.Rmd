...
Statistical evidence confirms that airplane has become safer over time regarding survivability. linear regression analysis reveals a statistically significant negative correlation between year and fatality rate (p < 0.001). 
...
## Is the number of crash event higher or lower over the years?
```{r}
